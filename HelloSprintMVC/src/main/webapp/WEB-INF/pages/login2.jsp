...
<meta charset="utf-8" />
<title>java</title>
<link rel="stylesheet" href="/HelloSprintMVC/css/style.css" />
</head>
<body>
	...
	<script type="text/javascript" src="/HelloSprintMVC/js/md5.js"></script>
	<script type="text/javascript" src="/HelloSprintMVC/js/global.js"></script>
	<script type="text/javascript" src="/HelloSprintMVC/js/pageLogin.js"></script>
</body>
</html>